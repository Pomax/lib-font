Need to install the following packages:
  rollup
Ok to proceed? (y) 
[36m[1m//→ lib-font.js:[22m[39m
export { F as Font } from './lib-font-e84b721a.js';

[36m[1m//→ lib-font-e84b721a.js:[22m[39m
/**
...
Promise.all([
  // opentype tables
  import('./cmap-fc84cdb0.js'),
  import('./head-99ed6be1.js'),
  import('./hhea-cd879769.js'),
  import('./hmtx-87d2b5d8.js'),
  import('./maxp-f946e987.js'),
  import('./name-70bebbce.js'),
  import('./OS2-b32c78bd.js'),
  import('./post-a6d92785.js'),

  // opentype tables that rely on the "common layout tables" data structures
  import('./BASE-38a70804.js'),
  import('./GDEF-85a09c88.js'),
  import('./GSUB-aa6cc102.js'),
  import('./GPOS-ac4a916a.js'),

  // SVG tables... err... table
  import('./SVG-9b5dcbb8.js'),

  // Variable fonts
  import('./fvar-984d78a3.js'),

  // TTF tables
  import('./cvt-77f8417d.js'),
  import('./fpgm-8b1acd48.js'),
  import('./gasp-8d65f9c9.js'),
  import('./glyf-3a1e7354.js'),
  import('./loca-d1b7385b.js'),
  import('./prep-d329de1f.js'),

  // CFF
  import('./CFF-83c215ec.js'),
  import('./CFF2-45dd3eca.js'),
  import('./VORG-42905a14.js'),

  // bitmap
  import('./EBLC-ae5c0f9d.js'),
  import('./EBDT-72bfddcd.js'),
  import('./EBSC-b5bd9eae.js'),
  import('./CBLC-4800f0a6.js'),
  import('./CBDT-d329d1d8.js'),
  import('./sbix-9470eedd.js'),

  // color
  import('./COLR-4ff1825e.js'),
  import('./CPAL-76192403.js'),

  // "other" tables
  import('./DSIG-092dbd25.js'),
  import('./hdmx-ba1bbe23.js'),
  import('./kern-73ebf6b8.js'),
  import('./LTSH-6628401c.js'),
  import('./MERG-c58cb5d5.js'),
  import('./meta-e050fd4b.js'),
  import('./PCLT-82308c42.js'),
  import('./VDMX-fd3e4c57.js'),
  import('./vhea-1c3fc760.js'),
  import('./vmtx-7ddd2859.js'),
])
...
[36m[1m//→ cmap-fc84cdb0.js:[22m[39m
import { P as ParsedData, l as lazy, S as SimpleTable } from './lib-font-e84b721a.js';
...
[36m[1m//→ head-99ed6be1.js:[22m[39m
import { S as SimpleTable } from './lib-font-e84b721a.js';
...
[36m[1m//→ hhea-cd879769.js:[22m[39m
import { S as SimpleTable } from './lib-font-e84b721a.js';
...
[36m[1m//→ hmtx-87d2b5d8.js:[22m[39m
import { S as SimpleTable, l as lazy } from './lib-font-e84b721a.js';
...
[36m[1m//→ maxp-f946e987.js:[22m[39m
import { S as SimpleTable } from './lib-font-e84b721a.js';
...
[36m[1m//→ name-70bebbce.js:[22m[39m
import { S as SimpleTable, l as lazy } from './lib-font-e84b721a.js';
...
[36m[1m//→ OS2-b32c78bd.js:[22m[39m
import { S as SimpleTable } from './lib-font-e84b721a.js';
...
[36m[1m//→ post-a6d92785.js:[22m[39m
import { S as SimpleTable } from './lib-font-e84b721a.js';
...
[36m[1m//→ BASE-38a70804.js:[22m[39m
import { S as SimpleTable, l as lazy } from './lib-font-e84b721a.js';
...
[36m[1m//→ GDEF-85a09c88.js:[22m[39m
import { S as SimpleTable, l as lazy, P as ParsedData } from './lib-font-e84b721a.js';
import { C as CoverageTable } from './coverage-d3757192.js';
...
[36m[1m//→ coverage-d3757192.js:[22m[39m
import { P as ParsedData } from './lib-font-e84b721a.js';
...
[36m[1m//→ GSUB-aa6cc102.js:[22m[39m
import { C as CommonLayoutTable } from './common-layout-table-c1def19b.js';
import './lib-font-e84b721a.js';
import './coverage-d3757192.js';
...
[36m[1m//→ common-layout-table-c1def19b.js:[22m[39m
import { P as ParsedData, S as SimpleTable, l as lazy } from './lib-font-e84b721a.js';
import { C as CoverageTable } from './coverage-d3757192.js';
...
[36m[1m//→ GPOS-ac4a916a.js:[22m[39m
import { C as CommonLayoutTable } from './common-layout-table-c1def19b.js';
import './lib-font-e84b721a.js';
import './coverage-d3757192.js';
...
[36m[1m//→ SVG-9b5dcbb8.js:[22m[39m
import { S as SimpleTable, P as ParsedData } from './lib-font-e84b721a.js';
...
[36m[1m//→ fvar-984d78a3.js:[22m[39m
import { S as SimpleTable, l as lazy } from './lib-font-e84b721a.js';
...
[36m[1m//→ cvt-77f8417d.js:[22m[39m
import { S as SimpleTable, l as lazy } from './lib-font-e84b721a.js';
...
[36m[1m//→ fpgm-8b1acd48.js:[22m[39m
import { S as SimpleTable, l as lazy } from './lib-font-e84b721a.js';
...
[36m[1m//→ gasp-8d65f9c9.js:[22m[39m
import { S as SimpleTable, l as lazy } from './lib-font-e84b721a.js';
...
[36m[1m//→ glyf-3a1e7354.js:[22m[39m
import { S as SimpleTable } from './lib-font-e84b721a.js';
...
[36m[1m//→ loca-d1b7385b.js:[22m[39m
import { S as SimpleTable, l as lazy } from './lib-font-e84b721a.js';
...
[36m[1m//→ prep-d329de1f.js:[22m[39m
import { S as SimpleTable, l as lazy } from './lib-font-e84b721a.js';
...
[36m[1m//→ CFF-83c215ec.js:[22m[39m
import { S as SimpleTable, l as lazy } from './lib-font-e84b721a.js';
...
[36m[1m//→ CFF2-45dd3eca.js:[22m[39m
import { S as SimpleTable, l as lazy } from './lib-font-e84b721a.js';
...
[36m[1m//→ VORG-42905a14.js:[22m[39m
import { S as SimpleTable, l as lazy } from './lib-font-e84b721a.js';
...
[36m[1m//→ EBLC-ae5c0f9d.js:[22m[39m
...
[36m[1m//→ shared-800f134c.js:[22m[39m
class BitmapSize {
  constructor(p) {
...
[36m[1m//→ EBDT-72bfddcd.js:[22m[39m
import { S as SimpleTable } from './lib-font-e84b721a.js';
...
[36m[1m//→ EBSC-b5bd9eae.js:[22m[39m
...
[36m[1m//→ CBLC-4800f0a6.js:[22m[39m
import { EBLC } from './EBLC-ae5c0f9d.js';
...
[36m[1m//→ CBDT-d329d1d8.js:[22m[39m
import { EBDT } from './EBDT-72bfddcd.js';
import './lib-font-e84b721a.js';
...
[36m[1m//→ sbix-9470eedd.js:[22m[39m
import { S as SimpleTable, l as lazy } from './lib-font-e84b721a.js';
...
[36m[1m//→ COLR-4ff1825e.js:[22m[39m
import { S as SimpleTable } from './lib-font-e84b721a.js';
...
[36m[1m//→ CPAL-76192403.js:[22m[39m
import { S as SimpleTable, l as lazy } from './lib-font-e84b721a.js';
...
[36m[1m//→ DSIG-092dbd25.js:[22m[39m
import { S as SimpleTable } from './lib-font-e84b721a.js';
...
[36m[1m//→ hdmx-ba1bbe23.js:[22m[39m
import { S as SimpleTable } from './lib-font-e84b721a.js';
...
[36m[1m//→ kern-73ebf6b8.js:[22m[39m
import { S as SimpleTable, l as lazy } from './lib-font-e84b721a.js';
...
[36m[1m//→ LTSH-6628401c.js:[22m[39m
import { S as SimpleTable } from './lib-font-e84b721a.js';
...
[36m[1m//→ MERG-c58cb5d5.js:[22m[39m
import { S as SimpleTable, l as lazy } from './lib-font-e84b721a.js';
...
[36m[1m//→ meta-e050fd4b.js:[22m[39m
import { S as SimpleTable } from './lib-font-e84b721a.js';
...
[36m[1m//→ PCLT-82308c42.js:[22m[39m
import { S as SimpleTable } from './lib-font-e84b721a.js';
...
[36m[1m//→ VDMX-fd3e4c57.js:[22m[39m
import { S as SimpleTable } from './lib-font-e84b721a.js';
...
[36m[1m//→ vhea-1c3fc760.js:[22m[39m
import { S as SimpleTable } from './lib-font-e84b721a.js';
...
[36m[1m//→ vmtx-7ddd2859.js:[22m[39m
import { S as SimpleTable } from './lib-font-e84b721a.js';
