...
if (matrix.shift()) {
    ...
    otf.onload = evt => console.log(`otf`, otf.font.tables.head);
...
if (matrix.shift()) {
    ...
    otfWoff.onload = evt => console.log(`otf.woff`, otfWoff.font.tables.head);
...
if (matrix.shift()) {
    ...
    otfWoff2.onload = evt => console.log(`otf.woff2`, otfWoff2.font.tables.head);
...
if (matrix.shift()) {
    ...
    varOtf.onload = evt => console.log(`otf (var)`, varOtf.font.tables.head);
...
if (matrix.shift()) {
    ...
    varOtfWoff.onload = evt => console.log(`otf.woff (var)`, varOtfWoff.font.tables.head);
...
if (matrix.shift()) {
    ...
    varOtfWoff2.onload = evt => console.log(`otf.woff2 (var)`, varOtfWoff2.font.tables.head);
...
if (matrix.shift()) {
    ...
    ttf.onload = evt => console.log(`ttf`, ttf.font.tables.head);
...
if (matrix.shift()) {
    ...
    ttfWoff.onload = evt => console.log(`ttf.woff`, ttfWoff.font.tables.head);
...
if (matrix.shift()) {
    ...
    ttfWoff2.onload = evt => console.log(`ttf.woff2`, ttfWoff2.font.tables.head);
...
if (matrix.shift()) {
    ...
    varTTf.onload = evt => console.log(`ttf (var)`, varTTf.font.tables.head);
...
if (matrix.shift()) {
    ...
    varTTfWoff.onload = evt => console.log(`ttf.woff (var)`, varTTfWoff.font.tables.head);
...
if (matrix.shift()) {
    ...
    varTTfWoff2.onload = evt => console.log(`ttf.woff2 (var)`, varTTfWoff2.font.tables.head);
